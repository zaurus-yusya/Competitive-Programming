...
int main() {
    ...
    rep(T, t){
        ...
        vector<ll> tree_x_sum_square(n+1);
        vector<ll> tree_y_sum_square(n+1);
        rep(i, n){
            tree_x_sum_square[i+1] = tree_x_sum_square[i] + tree_x[i] * tree_x[i];
            tree_y_sum_square[i+1] = tree_y_sum_square[i] + tree_y[i] * tree_y[i];
        }
        ...
        rep(i, q){
            ...
            ans += tree_x_sum_square[n];
            ans += tree_y_sum_square[n];
