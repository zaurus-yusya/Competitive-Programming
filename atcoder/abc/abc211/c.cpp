...
int main() {
    ...
    */
    ...
    /*
    vector<vector<ll>> vec(8);
    
    rep(i, s.size()){
        if(s[i] == 'c') vec[0].push_back(i);
        if(s[i] == 'h') vec[1].push_back(i);
        if(s[i] == 'o') vec[2].push_back(i);
        if(s[i] == 'k') vec[3].push_back(i);
        if(s[i] == 'u') vec[4].push_back(i);
        if(s[i] == 'd') vec[5].push_back(i);
        if(s[i] == 'a') vec[6].push_back(i);
        if(s[i] == 'i') vec[7].push_back(i);
    }
