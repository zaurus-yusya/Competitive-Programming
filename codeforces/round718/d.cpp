...
int main() {
    ...
    ll n, m, k; cin >> n >> m >> k; // n, m <= 500, k <= 20
    vector<vector<ll>> yoko(n, vector<ll>(m-1));
    vector<vector<ll>> tate(n-1, vector<ll>(m));
    ...
    vector<vector<ll>> kyori(n, vector<ll>(m, -1));
    ...
    rep(i, n){
        rep(j, m){
            ...
            kyori.assign(n, vector<ll>(m, INF));
