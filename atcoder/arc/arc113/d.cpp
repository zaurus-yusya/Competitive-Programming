...
int main() {
    ...
    if(n == 1){
        for(ll i = 1; i <= k; i++){
            mint max_row_toori = 1;
            mint col_toori = mpow.modpow((k-i+1), m) - mpow.modpow((k-i+1 - 1), m);
            ans += max_row_toori * col_toori;
        }
        cout << ans << endl;
        return 0;
    }
    ...
    if(m == 1){
        for(ll i = 1; i <= k; i++){
            mint max_row_toori = mpow.modpow(i, n) - mpow.modpow(i-1, n);
            if(i == 1) max_row_toori = 1;
            ans += max_row_toori;
        }
        cout << ans << endl;
        return 0;
    ...
    for(ll i = 1; i <= k; i++){
        ...
        mint max_row_toori = mpow.modpow(i, n) - mpow.modpow(i-1, n);
        if(i == 1) max_row_toori = 1;
        //cout << max_row_toori << endl;

        mint col_toori = mpow.modpow((k-i+1), m);
        ans += max_row_toori * col_toori;
